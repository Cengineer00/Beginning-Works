...
$x=require "PHP/class.basicdb.php";




$fırsat = $db -> from('urunler')
	-> select("id")
	-> where ("fırsat","1")
	-> all();

$fırsatad = $db -> from("urunler")
	->select("isim")
	-> where ("fırsat","1")
	-> all();

$fırsatfiyat = $db -> from("urunler")
	->select("fiyat")
	-> where ("fırsat","1")
	-> all();


$yeni = $db -> from("urunler")
	->select("id")
	->where("yeni","1")
	->all();

$yeniad = $db -> from("urunler")
	->select("isim")
	-> where ("yeni","1")
	-> all();

$yenifiyat = $db -> from("urunler")
	->select("fiyat")
	-> where ("yeni","1")
	-> all();

$ucretsizkargo = $db -> from("urunler")
	-> select("ucretsiz_kargo")
	-> all();
...
<body>
	...
	<header>
		<div class="sınırla">
			...
			<div class="arama">
				<form action="PHP/arama.php" method="get" enctype="multipart/form-data">
	...
	<div class="menu">
		<ul>
			...
			<li><a href="PHP/kategoriler/kayisicesit.php">Kayısı Çeşitleri</a></li>
			<li><a href="#">Kayısı Yan Ürünleri</a><i class="fa fa-angle-down"></i></li>
			<li><a href="PHP/kategoriler/kuruyemis.php">Kuruyemiş</a><i class="fa fa-angle-down"></i></li>
			<li><a href="#">Hediyelik Ürünler</a><i class="fa fa-angle-down"></i></li>
			<li><a href="#">Şekerlemeler</a><i class="fa fa-angle-down"></i></li>
		</ul>
	</div>
	<!-- ARKAPLAN -->
	<div class="arkaplan"><a href=""><img src="img/arkaplan.png" alt="" /></a></div>
	<div class="yöntemler">
		<ul>
			<li><img src="img/hızlı gönderim.png" alt="" /></li>
			<li><img src="img/iade değişim.png" alt="" /></li>
			<li><img src="img/telefona sipariş.png" alt="" /></li>
			<li><img src="img/ödeme yöntemleri.png" alt="" /></li>
		</ul>
	</div>
	<!-- CENTER -->
	<div class="center">
		<div class="başlık">EN ÇOK TERCİH EDİLEN ÜRÜNLERİMİZ</div>
		<div class="tercihürünler">

			<?php $x= 0;
			while ($x<= 9) { ?>
				<span>
					<a href=""><img src="img/id<?=$fırsat[$x]["id"];?>.png" alt="kayısı" /></a>
					<div> <?=$fırsatad[$x]["isim"];?>  <br /><?=$fırsatfiyat[$x]["fiyat"]?> TL / kg <?php if ($ucretsizkargo[($fırsat[$x]["id"]-1)]["ucretsiz_kargo"]) { ?><span class="kargo">ÜCRETSİZ KARGO</span> <?php } ?> </div>
				</span>
			<?php $x++; } ?>
		...
		<div class="tü2">
			<span>
				<img src="img/2.1.png" alt="" width="309" height="255"/>
				<span id="kuruyemişler"><p>KURUYEMİŞLER</p> <a href="PHP/kategoriler/kuruyemis.php"><p>ALIŞVERİŞE BAŞLA</p></a></span><br />
				<span class="tatlı"><a href="#"><img src="img/2.4.png" alt="kayısı" /></a></span>
			</span>
			<span>
				<div id="cezerye"><a href="#"><img src="img/2.2.png" alt="kayısı" /></a></div>
			</span>
			<span>
				<div><a href="#"><img src="img/2.3.png" alt="kayısı" /></a></div>
				<div><a href="#"><img src="img/2.5.png" alt="kayısı" /></a></div>
			</span>			
		</div>
		<div class="başlık2">YENİ ÜRÜNLER</div>
		<div class="yeniürünler">
			<?php $x= 0;
			while ($x<= 7) { ?>
				<span>
					<a href=""><img src="img/id<?=$yeni[$x]["id"];?>.png" alt="kayısı" width="273" height="178"/></a>
					<div><?=$yeniad[$x]["isim"];?> <br /><?=$yenifiyat[$x]["fiyat"];?> TL / kg <?php if ($ucretsizkargo[($yeni[$x]["id"]-1)]["ucretsiz_kargo"]) { ?><span class="kargo2">ÜCRETSİZ KARGO</span> <?php } ?></div>
				</span>
			<?php $x++; } ?>
		</div>	
		<div class="başlık3">İNDİRİMLİ FIRSAT ÜRÜNLERİ</div>
			<div class="fırsatürünler">
				<span><a href="#"><img src="img/3.1.png" alt="fırsat" width="547" height="344"/></a></span>
				<span><a href="#"><img src="img/3.2.png" alt="fırsat" width="547" height="344"/></a></span>
			</div>
	</div>
	<!-- FOOTER -->
	<div class="footer">
